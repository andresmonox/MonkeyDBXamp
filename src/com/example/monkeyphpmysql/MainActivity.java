package com.example.monkeyphpmysql;
...
public class MainActivity extends ActionBarActivity {
    ...
    public void syncSQLiteMySQLDB() {
        ...
        client.post("http://localhost/MonkeyDB/getusers.php", params, new AsyncHttpResponseHandler() {
                @Override
    ...
    public void updateMySQLSyncSts(String json) {
        ...
        client.post("http://localhost/MonkeyDB/updatesyncsts.php", params, new AsyncHttpResponseHandler() {
            @Override
            public void onSuccess(String response) {
